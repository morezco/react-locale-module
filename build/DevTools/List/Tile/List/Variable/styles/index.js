...
export var Header = styled.header(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n\n  cursor: pointer;\n\n  height: 50px;\n\n  padding: 0 ", ";\n\n  position: sticky;\n  top: 0px;\n"], ["\n  display: flex;\n  align-items: center;\n\n  cursor: pointer;\n\n  height: 50px;\n\n  padding: 0 ", ";\n\n  position: sticky;\n  top: 0px;\n"])), function (_a) {
    var open = _a.open;
    return (open ? "40px" : "0px");
});
export var Body = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  padding: 0 20px;\n\n  max-width: 300px;\n\n  overflow: hidden;\n\n  div {\n    display: flex;\n    justify-content: space-between;\n\n    padding: 0 20px;\n  }\n"], ["\n  padding: 0 20px;\n\n  max-width: 300px;\n\n  overflow: hidden;\n\n  div {\n    display: flex;\n    justify-content: space-between;\n\n    padding: 0 20px;\n  }\n"])));
export var Icon = function () { return React.createElement(Memory, { size: 24 }); };
export var Equal = function () { return React.createElement(Equals, { size: 16 }); };
