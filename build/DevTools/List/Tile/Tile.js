...
export default function Tile(_a) {
    var title = _a.title, language = _a.language, languages = _a.languages, data = _a.data, index = _a.index;
    ...
    return (React.createElement(Container, { index: index, onClick: toggle, open: open },
        React.createElement(Header, { index: index, open: open, data: data }, title),
