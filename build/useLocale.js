...
export function useLocale(context, dictionary, data) {
    ...
    var t = useCallback(function (original) {
        var _a, _b;
        return !context || !dictionary
            ? null
            : (((_b = (_a = contexts === null || contexts === void 0 ? void 0 : contexts[context]) === null || _a === void 0 ? void 0 : _a[language]) === null || _b === void 0 ? void 0 : _b[original]) ||
                original);
    ...
    var l = useCallback(function (original, check) {
        ...
        if (translationObject) {
            ...
            return !context ? null : (React.createElement(TextComponent, { editing: devTools && !!highlighted }, String(translation)));
        }
        else {
